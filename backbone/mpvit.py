...
class MPViT(nn.Module):
    """
    Multi-path vision transformer, rewrapper of official code
    """
    ...
    url_setting = {
        **dict.fromkeys(
            ['t', 'tiny'],
            'https://dl.dropboxusercontent.com/s/1cmquqyjmaeeg1n/mpvit_tiny.pth'
        ),
        **dict.fromkeys(
            ['xs', 'xsmall'],
            'https://dl.dropboxusercontent.com/s/vvpq2m474g8tvyq/mpvit_xsmall.pth'
        ),
        **dict.fromkeys(
            ['s', 'small'],
            'https://dl.dropboxusercontent.com/s/y3dnmmy8h4npz7a/mpvit_small.pth'
        ),
        **dict.fromkeys(
            ['b', 'base'],
            'https://dl.dropboxusercontent.com/s/la8w31m0apj2830/mpvit_base.pth'
        )
    }
    ...
    def __init__(self, 
        ...
        self.num_path = self.arch_settings['num_path']
        ...
        self.stem = mpvit.stem
        self.num_stages = mpvit.num_stages
        self.patch_embed_stages = mpvit.patch_embed_stages
        self.mhca_stages = mpvit.mhca_stages  # num_stages=4
